...
test('action sequence', () => {
    ...
    const actionSequence = [
        ...
        actions.addPlayer('BOBA', 'wes', 'goldTeam'),
        ...
        actions.addPlayer('BOBA', 'dan', 'redTeam'),
        actions.buzz('BOBA', 'wes'),
        actions.buzz('BOBA', 'dan'),
        actions.addPoints('BOBA', 'pass', 'redTeam', 3)
    ];
    ...
    const expected = {
        BOBA: {
            id: 'BOBA',
            passcode: 'pass',
            players: { wes: 'goldTeam', dan: 'redTeam' },
            teams: { goldTeam: ['wes'], redTeam: ['dan'] },
            buzzed: [['goldTeam', 'wes'], ['redTeam', 'dan']],
            scores: { goldTeam: 0, redTeam: 3 },
            questions: [
